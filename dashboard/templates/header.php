            ...
            <div class="collapse collapse-horizontal h-100 show" id="collapseWidthExample">
                <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark h-100" style="width: 280px;">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        <li>
                            <a href="index.php" class="nav-link text-white <?= str_contains($_SERVER['SCRIPT_NAME'], 'TugasBesar/dashboard/index.php') ? 'active': '' ?>">
                                <i data-feather="home" class="me-3"></i>
                                Dashboard
                            </a>
                        </li>
                        <li>
                            <a href="list.php" class="nav-link text-white <?= str_contains($_SERVER['SCRIPT_NAME'], 'TugasBesar/dashboard/list.php') ? 'active': '' ?>">
